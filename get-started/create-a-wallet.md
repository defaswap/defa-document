...
To get started on DeFa, the first thing you'll need is to set up a wallet that supports BNB Smart Chain (BSC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with DeFa.

| Feature                                                  | Token Pocket | MetaMask | Coinbase Wallet |          Trust Wallet         | SafePal |
| -------------------------------------------------------- | :----------: | :------: | :-------------: | :---------------------------: | :-----: |
...
![](<../.gitbook/assets/trust wallet.png>)
...
| Feature                                                  | MetaMask | Binance Wallet | Coinbase Wallet | Token Pocket |
| -------------------------------------------------------- | :------: | :------------: | :-------------: | :----------: |
...
The genuine DeFa site and staff will never ask you to input your seed phrase.
{% endhint %}
